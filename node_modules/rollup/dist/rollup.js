...
function errIncompatibleExportOptionValue(optionValue, keys, entryModule) {
    return {
        ...
        message: `"${optionValue}" was specified for "output.exports", but entry module "${index.relativeId(entryModule)}" has the following exports: ${keys.join(', ')}`
    };
}
...
function errMixedExport(facadeModuleId, name) {
    return {
        ...
        id: facadeModuleId,
        message: `Entry module "${index.relativeId(facadeModuleId)}" is using named and default exports together. Consumers of your bundle will have to use \`${name ||
